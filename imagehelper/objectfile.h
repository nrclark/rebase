 ...
 *
 * $Id: objectfile.h,v 1.6 2002/12/31 12:56:48 habacker Exp $
 */
...
public:
  ...
  PIMAGE_NT_HEADERS32 getNTHeader32(void) { return ntheader; }

  bool isLoaded(void) { return Error == 0; }

  bool is64bit(void) { return is64bit_img; }

  bool is32bit(void) { return !is64bit_img; }

  WORD machine(void) { return machine_type; }

  int getError(void) { return Error; }

  SectionList *getSections(void) { return sections; }
...
public:
  ...
  bool unbind(void);
  bool checkRelocations(void) { return relocs->check(); }
  bool fixRelocations(void) { return relocs->fix(); }
  ...
  Exports *getExports() { return exports; }
