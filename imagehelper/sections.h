 ...
 *
 * $Id: sections.h,v 1.5 2003/02/14 08:19:03 habacker Exp $
 */
...
/// Its encapsulate the IMAGE_SECTION_HEADER structure from the windows header
/// file
class SectionHeader : public IMAGE_SECTION_HEADER {};

/// the image data directory.
/// Its encapsulate the IMAGE_EXPORT_DIRECTORY structure from the windows header
/// file
class ExportDirectory : public IMAGE_EXPORT_DIRECTORY {};

/// the image data directory.
/// Its encapsulate the IMAGE_DATA_DIRECTORY structure from the windows header
/// file
class DataDirectory : public IMAGE_DATA_DIRECTORY {};

/// the image data directory.
/// Its encapsulate the IMAGE_IMPORT_DESCRIPTOR structure from the windows
/// header file
class ImportDescriptor : public IMAGE_IMPORT_DESCRIPTOR {};

/// the bound import descriptor.
/// Its encapsulate the IMAGE_BOUND_IMPORT_DESCRIPTOR structure from the windows
/// header file
...
public:
  ptrdiff_t getAdjust() { return adjust; }
...
public:
  ...
  int getVirtualAddress(void) { return header->VirtualAddress; }
  int getSize(void) { return header->SizeOfRawData; }
  ...
  void *rva2real(uint addr = 0) { return (void *)(addr + adjust); }
...
public:
  // create a relocation object using section named "section" from  the section
  // list "sections"
