 ...
 *
 * $Id: objectfilelist.cc,v 1.3 2003/01/02 20:07:35 habacker Exp $
 */
...
ObjectFileList::ObjectFileList() { count = 0; }

bool ObjectFileList::add(ObjectFile *obj) {
  if (count < 1000) {
    list[count++] = obj;
    return true;
  }
...
ObjectFile *ObjectFileList::get(char *FileName) {
  ObjectFile *p;
  reset();
